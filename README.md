...
- **Child & family safety in human–AI interaction**  
...
### Human–AI interaction, privacy, and safety

- **Family-Safe GenAI & Parental Controls**  
  *Mixed-methods study + prototype*  
...
- **Explainability Sanity Checks with LIME**  
  *Reproducing and extending XAI sanity checks*  
  - Experiments on how stable and trustworthy LIME explanations are under different perturbations and model settings.  
  - Repo: [`XAI-Sanity-Checks-and-Understanding-LIME`](https://github.com/jjdrisco/XAI-Sanity-Checks-and-Understanding-LIME)

- **Topic Modeling: NMF vs BERTopic**  
  *Classical vs transformer-based topic models*  
  - Comparative analysis of NMF and BERTopic on real-world text data, including evaluation metrics and visualizations.  
  - Repo: [`Topic-Modeling_NMF-vs-BERTopic`](https://github.com/jjdrisco/Topic-Modeling_NMF-vs-BERTopic)

- **Predicting NYPD Response Times**  
  *Public safety + ML pipeline*  
  - End-to-end pipeline (data cleaning, feature engineering, modeling, evaluation) for predicting NYPD emergency response times from public 911 data.  
  - Repo: [`Predicting_NYPD_Response_Times`](https://github.com/jjdrisco/Predicting_NYPD_Response_Times)

- **Analyzing San Diego Potholes**  
  *Infrastructure equity & service patterns*  
  - Spatial analysis and visualization of San Diego 311 pothole requests to explore how service varies across neighborhoods.  
  - Repo: [`Analyzing_San_Diego_Potholes`](https://github.com/jjdrisco/Analyzing_San_Diego_Potholes)

- **Hybrid Graph-Based Content Filtering for Music Recommendation**  
  *Recommender systems & graph-based methods*  
  - Explores hybrid graph/content-based filtering for music recommendation.  
  - Repo: [`Hybrid_Graph-Based_Content_Filtering_for_Enhanced_Music_Recommendation`](https://github.com/jjdrisco/Hybrid_Graph-Based_Content_Filtering_for_Enhanced_Music_Recommendation)

- **Global Art Exploration and Analysis**  
  *Knowledge graphs & cultural data*  
  - Uses Neo4j, PostgreSQL, and Redis to explore and analyze global art collections.  
  - Repo: [`Global_Art_Exploration_and_Analysis`](https://github.com/jjdrisco/Global_Art_Exploration_and_Analysis)
...
Full list and PDFs on [Google Scholar](https://scholar.google.com/citations?user=Pi5C4hwAAAAJ&hl=en).

---

## 📫 Get in touch

- Email: `jjdrisco [at] ucsd.edu`  
- LinkedIn: [linkedin.com/in/jjdrisco](https://www.linkedin.com/in/jjdrisco/)  
